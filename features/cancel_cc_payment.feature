Feature: Cancel a credit card payment behavior

  Background:

         When I'm logged in with 1234
         Then I press "Hosen" and I add "Hose für Jungen blau" to my basket 1 time and I press "CartGoToPayment"
         Then I conduct a card payment with "Kredit-Karte"

  Scenario: As a valid user I go to the Bonjournal and cancel a credit card transaction       
         ...
         Then I select field-id "CancelDialogNote" and enter text "Kredit-Karten-Stornierung"
