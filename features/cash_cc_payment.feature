Feature: Split payment behavior cash-/credit card and reverse order
  ...
  Scenario: As a valid user I use the cash + credit card split payment     
  ...
  Scenario: As a valid user I use the credit card + cash split payment
