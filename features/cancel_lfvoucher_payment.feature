Feature: Cancel a Locafox voucher payment behavior

  Background:

         When I'm logged in with 1234
         Then I press "Hosen" and I add "Hose für Jungen blau" to my basket 1 time and I press "CartGoToPayment"
         Then I conduct a payment with Locafox voucher

  Scenario: As a valid user I go to the Bonjournal and cancel a Locafox voucher transaction       
         ...
         Then I select field-id "CancelDialogNote" and enter text "LF-Gutschein-Stornierung"
         Then I press "CancelDialogOkButton"
         Then I wait upto 40 seconds for the "ActivityConfirmation" screen to appear
         Then I wait for 2 seconds
         Then the "SuccessReceiptTotalPrice" field should contain "-$21.66"
