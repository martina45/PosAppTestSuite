Feature: Split payment behavior ec card + foreign voucher and reverse order

  Background:
         When I'm logged in with 1234
         Then I press "Hosen" and I add "Hose für Jungen blau" to my basket 1 times and I press "CartGoToPayment"

  Scenario: As a valid user I use the ec card + foreign voucher split payment       
  ...
  Scenario: As a valid user I use the foreign voucher + ec card split payment  
