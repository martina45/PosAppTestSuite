Feature: Return product with chargeback behavior
  ...
  Scenario: As a valid user I conduct a return product transaction with chargeback in the Bonjournal        
         ...
         Then I press "cartEntryStock"
         Then I press "btnCashNumpad1"
         Then the "stockDialogTextView" field should contain "1"
