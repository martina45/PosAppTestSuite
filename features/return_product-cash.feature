Feature: Return product with cash behavior
  ...
  Scenario: As a valid user I conduct a product return transaction -cash payment- in the Bonjournal        
         ...
         Then I scroll "returnCheckoutPaymentTabLayout" to text "Bar" and touch it
